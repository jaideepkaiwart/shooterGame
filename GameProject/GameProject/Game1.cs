...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        private void SpawnBear()
        {
            ...
            float speed= GameConstants.MinBearSpeed + RandomNumberGenerator.NextFloat(GameConstants.MinBearSpeed + GameConstants.BearSpeedRange);
            // create new bear
            float theta = RandomNumberGenerator.NextFloat((float)Math.PI*2);
            Vector2 velocity = new Vector2(speed * (float)Math.Cos(theta), speed * (float)Math.Sin(theta));
