    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (mouse.LeftButton == ButtonState.Pressed && health > 0 && canShoot)
                {
                    canShoot = false;
                    Projectile frenchFriesProjectile = new Projectile(ProjectileType.FrenchFries, Game1.GetProjectileSprite(ProjectileType.FrenchFries), drawRectangle.X + drawRectangle.Width / 2, drawRectangle.Y + drawRectangle.Height / 2 - GameConstants.FrenchFriesProjectileOffset, GameConstants.FrenchFriesProjectileSpeed);
